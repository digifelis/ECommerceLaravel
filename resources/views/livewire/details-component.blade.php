                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="submit" class="button button-add-to-cart" wire:click.prevent="store({{$product->id}}, '{{$product->name}}', {{$product->sale_price}}, '{{$product->slug}}')">Add to cart</button>
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{route('product.details', ['slug' => $releated_product->slug])}}" tabindex="0">
                                                            <img class="default-img" src="{{ asset('assets/imgs/shop/product-') }}{{$releated_product->id}}-1.jpg" alt="">
                                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-') }}{{$releated_product->id}}-2.jpg" alt="">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{route('product.details', ['slug' => $releated_product->slug])}}" tabindex="0">{{$releated_product->name}}</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                                                    <div class="product-price">
                                                        <span>${{$releated_product->sale_price}} </span>
                                                        <span class="old-price">${{$releated_product->regular_price}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{ asset('assets/imgs/shop/product-') }}{{$new_product->id}}-1.jpg" alt="#">
                                </div>
