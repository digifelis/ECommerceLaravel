                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details', ['slug' => $featured_product->slug])}}">
                                                ...
                                                <img class="default-img" src="{{asset('assets/imgs/products/')}}/{{$featured_product->image}}" alt="">
                                                <img class="hover-img" src="{{asset('assets/imgs/products/')}}/{{$featured_product->image}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-eye"></i></a>
                                            <a aria-label="Add To Wishlist" class="action-btn hover-up" href="#" wire:click.prevent="addWishList({{$featured_product->id}}, '{{$featured_product->name}}', {{$featured_product->sale_price}}, '{{$featured_product->slug}}')"><i class="fi-rs-heart"></i></a>
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="shop.html">{{$featured_product->category->name}}</a>
                                        </div>
                                        <h2><a href="{{route('product.details', ['slug' => $featured_product->slug])}}">{{$featured_product->name}}</a></h2>
                                        <div class="product-price">
                                            <span>${{$featured_product->sale_price}} </span>
                                            <span class="old-price">${{$featured_product->regular_price}}</span>
                                        </div>
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store({{$featured_product->id}}, '{{$featured_product->name}}', {{$featured_product->sale_price}}, '{{$featured_product->slug}}')"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details', ['slug' => $popular_product->slug])}}">
                                                ...
                                                <img class="default-img" src="{{asset('assets/imgs/products/')}}/{{$popular_product->image}}" alt="">
                                                <img class="hover-img" src="{{asset('assets/imgs/products/')}}/{{$popular_product->image}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-eye"></i></a>
                                            <a aria-label="Add To Wishlist" class="action-btn hover-up" href="#" wire:click.prevent="addWishList({{$popular_product->id}}, '{{$popular_product->name}}', {{$popular_product->sale_price}}, '{{$popular_product->slug}}')"><i class="fi-rs-heart"></i></a>
                                            <a aria-label="Compare" class="action-btn hover-up" href="compare.php"><i class="fi-rs-shuffle"></i></a>
                                        </div>
                                        <div class="product-badges product-badges-position product-badges-mrg">
                                            <span class="hot">Hot</span>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{route('product.details', ['slug' => $popular_product->slug])}}">{{$popular_product->name}}</a></h2>
                                        <div class="product-price">
                                            <span>${{$popular_product->sale_price}} </span>
                                            <span class="old-price">${{$popular_product->regular_price}}</span>
                                        </div>
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store({{$popular_product->id}}, '{{$popular_product->name}}', {{$popular_product->sale_price}}, '{{$popular_product->slug}}')"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @foreach($recent_products as $recent_product)
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details', ['slug' => $recent_product->slug])}}">
                                                
                                                <img class="default-img" src="{{asset('assets/imgs/products/')}}/{{$recent_product->image}}" alt="">
                                                <img class="hover-img" src="{{asset('assets/imgs/products/')}}/{{$recent_product->image}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-eye"></i></a>
                                            <a aria-label="Add To Wishlist" class="action-btn hover-up" href="#" wire:click.prevent="addWishList({{$recent_product->id}}, '{{$recent_product->name}}', {{$recent_product->sale_price}}, '{{$recent_product->slug}}')"><i class="fi-rs-heart"></i></a>
                                            <a aria-label="Compare" class="action-btn hover-up" href="compare.php"><i class="fi-rs-shuffle"></i></a>
                                        </div>
                                        <div class="product-badges product-badges-position product-badges-mrg">
                                            <span class="hot">Hot</span>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{route('product.details', ['slug' => $recent_product->slug])}}">{{$recent_product->name}}</a></h2>
                                        <div class="product-price">
                                            <span>${{$recent_product->sale_price}} </span>
                                            <span class="old-price">${{$recent_product->regular_price}}</span>
                                        </div>
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store({{$recent_product->id}}, '{{$recent_product->name}}', {{$recent_product->sale_price}}, '{{$recent_product->slug}}')"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
