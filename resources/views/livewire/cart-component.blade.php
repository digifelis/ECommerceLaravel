                                        ...
                                        @foreach(Cart::instance('shopping')->content() as $item)
                                            <tr>
                                                ...
                                                <td class="product-des product-name">
                                                    <h5 class="product-name"><a href="{{$item->options->slug}}">{{{$item->name}}}</a></h5>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><span class="font-lg fw-900 text-brand">${{Cart::instance('shopping')->subtotal()}}</span></td>
                                                </tr>
                                                <tr>
                                                    <td class="cart_total_label">Cart Tax</td>
                                                    <td class="cart_total_amount"><span class="font-lg fw-900 text-brand">${{Cart::instance('shopping')->tax()}}</span></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><strong><span class="font-xl fw-900 text-brand">${{Cart::instance('shopping')->total()}}</span></strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
